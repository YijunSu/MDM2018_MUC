...
if __name__ == '__main__':
    ...
    train_file = data_dir + "Foursquare_checkins_Train.txt"
    test_file = data_dir + "Foursquare_checkins_Test.txt"
    user_location_friends_file = data_dir + "Foursquare_location_friends.txt"
    user_neighbor_friends_file = data_dir + "Foursquare_neighbor_friends_20.txt"
    user_social_friends_file = data_dir + "Foursquare_social_friends_1.txt"
    user_features_file = data_dir + "Foursquare_user_features_1_20.txt"
